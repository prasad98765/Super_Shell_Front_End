      ...
      <>
        ...
        <div class="row">
          <div class="col-12 col-md-8 ">
            ...
            <p >
            We “Super Shell Industries” are involved as the Manufacturer of Our product range includes a wide range of 12 Volt 7.2AH UPS Battery, 12 Volt 4.5 AH VRLA Battery and 6 Volt 4.5 Ah VRLA Battery Sunaka Type and much more. These products are offered by us most affordable rates.
            </p>
            ...
            <div class="row">
                <div class="col-sm-8">
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Lead Calcium Grids for extended life
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> AGM Absorbent Glass Mat for efficient
                    
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Gas recombination
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> High Quality recovery from deep discharge
                    
                  </p>
                </div>
                <div class="col-sm-4 info">
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Multipurpose Float and Cycle Use
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Usable in any Orientation
                    
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Maintenance free operation
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Low self Discharge
                    
                  </p>
                </div>
              </div>
              <h6 style={{ fontWeight: "bold", marginTop: "-1%" }}>
            Application :
            </h6>
            <div class="row">
                <div class="col-sm-8">
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Agriculture Sprayer Pump
                  </p>
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> EPS (Electric Power System
                  ...
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> UPS (Interruptible Power Supply)
                ...
                <div class="col-sm-4 info">
                  ...
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Alarm And Security System
                  ...
                  <p>
                    <i class="fa fa-arrow-circle-right"></i> Communication power supply
